...
// var Event = function(name, details, time){
//     this.name = name;
...
// var firstEvent = new Event('blah', 'dancing on top of the moon', {year: 2018, month: 1, day: 30, hour: 20});

var createThis = function(name, details, time){
...
createThis('blah' , 'throwing spears at the sun', {year: 2017, month: 6, day: 15, hour: 6});
createThis('Shopping at Bazaar' , 'All your Base are Belong to Us' , {year: 2018, month: 2, day: 15});
